...
public class ImageCatchUtil {
    ...
    private final String ImageExternalCatchDir = MyApplication.getContext().getExternalCacheDir() + "/image_cache";
    ...
    public String getCacheSize() {
        String size = "";
        try {
            size =  getFormatSize(getFolderSize(new File(ImageExternalCatchDir)));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return size;
